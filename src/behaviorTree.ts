...
class BaseNode implements IBVNode {
    ...
    rest() { this._currentState = "INIT"; this.executeResult = null; }
...
export class BehaviorTree {
    ...
    private _execute() {
        if (this[RUNNING_NODE]) {
            return this[RUNNING_NODE][INTERNAL_TICK](this.blackBoard);
        } else {
